...
#Informatica
New-SmbShare -Name Informatica -Path $ruta -FullAccess Administradores -ReadAccess Informatica_GL `
-ChangeAccess Informatica_GL -ConcurrentUserLimit 28 `
#Alergologia
New-SmbShare -Name Alergologia -Path $ruta -FullAccess Administradores -ReadAccess Alergologia_GL `
-ChangeAccess Alergologia_GL -ConcurrentUserLimit 28 `
#Comunicación y Prensa 
New-SmbShare -Name Comunicacion_Prensa -Path $ruta -FullAccess Administradores -ReadAccess Comunicacion_Prensa_GL `
-ChangeAccess Comunicacion_Prensa_GL -ConcurrentUserLimit 28 `
#Enfermeria
New-SmbShare -Name Enfermeria -Path $ruta -FullAccess Administradores -ReadAccess Enfermeria_GL `
